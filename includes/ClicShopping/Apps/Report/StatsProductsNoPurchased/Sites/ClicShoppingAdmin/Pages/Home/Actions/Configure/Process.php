  ...
  class Process extends \ClicShopping\OM\PagesActionsAbstract
  {
    public function execute()
    {
      ...
      foreach ($m->getParameters() as $key) {
        ...
        if (isset($_POST[$p])) {
          $CLICSHOPPING_StatsProductsNoPurchased->saveCfgParam($key, $_POST[$p]);
        }
      }

      $CLICSHOPPING_MessageStack->add($CLICSHOPPING_StatsProductsNoPurchased->getDef('alert_cfg_saved_success'), 'success', 'StatsProductsNoPurchased');
