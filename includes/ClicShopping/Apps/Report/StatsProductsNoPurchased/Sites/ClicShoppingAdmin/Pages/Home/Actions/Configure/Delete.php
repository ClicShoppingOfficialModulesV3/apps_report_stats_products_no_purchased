  ...
  class Delete extends \ClicShopping\OM\PagesActionsAbstract
  {
    ...
    private static function removeMenu()
    {
      ...
      if ($Qcheck->fetch()) {
        ...
        $QMenuId->bindValue(':app_code', 'app_report_stats_products_no_purchased');
        $QMenuId->execute();
        ...
        $CLICSHOPPING_Db->delete('administrator_menu', ['app_code' => 'app_report_stats_products_no_purchased']);
      }
    }
  }